...
const Footer = () => {
            ...
            <div className="footer-top">
                ...
                <div className="footer-top-right">
                    <div className="social-buttons1">
                        <a href="https://github.com/Shaikh-Ayaz04" class="social-button github">
                        ...
                        <a href="https://www.linkedin.com/in/shaikhayaz04/" class="social-button linkedin">
    ...
    c-2.762,0-5,2.238-5,5v50.844C76.703,162.867,78.941,165.106,81.703,165.106z"></path>
                        ...
                        <a href="https://www.instagram.com/shaikh_ayaz_04_/" class="social-button instagram">
